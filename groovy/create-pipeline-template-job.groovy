...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/Prime-Deployment-Ninjas/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>Prime-Deployment-Ninjas</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>Prime-Deployment-Ninjas</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/Prime-Deployment-Ninjas/pipeline-template-catalog.git</repositoryUrl>
              <traits>
